...
export interface IMyFpaTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IMyFpaTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of My FPA remove page
 */
export class MyFpaTabRemove  extends TeamsBaseComponent<IMyFpaTabRemoveProps, IMyFpaTabRemoveState> {
